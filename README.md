...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `31.3µs` | `383.3µs` |
| [Day 2](./src/bin/02.rs) | `101.2µs` | `102.1µs` |
| [Day 3](./src/bin/03.rs) | `8.8ms` | `9.4ms` |
| [Day 4](./src/bin/04.rs) | `265.2µs` | `296.2µs` |
| [Day 5](./src/bin/05.rs) | `27.1µs` | `97.6µs` |
